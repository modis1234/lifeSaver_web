	...
	return Backbone.View.extend({
		...
		getCctvList: function (model, response) {
			...
			if(resLength>0){
				...
				_this.cctvInfo['port'] = _result['port'] || null;
				_this.cctvInfo['user_id'] = _result['user_id'] || null;
				_this.cctvInfo['password'] = _result['password'] || null;
			}
		},
